...
#ifndef __BSP_KEY_QUEUE_POINTER_H__
#define __BSP_KEY_QUEUE_POINTER_H__

#include "bsp_key_config.h"

/* Expose this interface only when pointer transfer is selected. */
...
typedef struct
{
    ...
    /* Only used to vary the event-structure size during pointer-transfer testing. */
    uint32_t           test_payload[100];
...
#endif /* End of __BSP_KEY_QUEUE_POINTER_H__ */
